...
export const WORKFLOW_CHANNELS: WorkflowChannel[] = [
  ...
  },
  {
    ...
    num: "04",
    name: "DOCS",
    hint: "Generate CV + surat · posisi B01–B02 di ORDER",
    tab: "ORDER",
    view: "order",
    orderFocus: "draft",
  },
  {
    ...
    num: "05",
    name: "APPLY",
    hint: "Siap submit manual · posisi B03 di ORDER",
    tab: "ORDER",
    view: "order",
    orderFocus: "ready",
  },
  ...
  },
  {
    ...
    num: "07",
    name: "FOLLOW",
    hint: "Pilih Applied / Interview · follow-up editor · posisi B04–B05 di ORDER",
    tab: "ORDER",
    view: "order",
    orderFocus: "follow",
  },
