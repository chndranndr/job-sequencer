...
export async function compileAndVerify(options:{currentDir:string;cvPages:number;coverLetterPages:number;email:string;phone:string;runner?:CommandRunner;now?:string;signal?:AbortSignal}):Promise<DocumentVerification>{
