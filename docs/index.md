...
- Job-source adapters, manifests, policy ledgers, and declarative custom-source resolution live in `src/server/source-plugins.ts`; built-in CLI and bounded public HTML adapters share the registry contract.
